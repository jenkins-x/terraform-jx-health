...
export JENKINS_X_URL='https://dashboard-jx.dev.jenkins-x.me/jenkins-x/terraform-jx-health/main/1'
...
export MINK_IMAGE='ghcr.io/jenkins-x/terraform-jx-health:0.0.1'
